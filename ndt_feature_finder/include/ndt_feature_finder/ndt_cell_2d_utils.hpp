...
// 			int index_tmp = getBiggestEigenVector2D(cell2, eigenval_tmp, eigenvec_tmp);
		 ...
		 */
		inline void angleNDTCells(const perception_oru::NDTCell& cell1, const perception_oru::NDTCell& cell2, const Eigen::Vector3d& collision_point, double& angle, double& angle_direction){
