...
namespace perception_oru{
	namespace ndt_feature_finder{
		...
		inline void getClosestCells(const lslgeneric::NDTMap& map, const lslgeneric::NDTCell& cell, int neig_size, std::vector< boost::shared_ptr< lslgeneric::NDTCell > >& cells_gaussian, std::vector< boost::shared_ptr< lslgeneric::NDTCell > >& cells_initialized);
...
// 			int index_tmp = getBiggestEigenVector2D(cell2, eigenval_tmp, eigenvec_tmp);
		 ...
		 */
		inline void angleNDTCells(const lslgeneric::NDTCell& cell1, const lslgeneric::NDTCell& cell2, const Eigen::Vector3d& collision_point, double& angle, double& angle_orientation){
...
// 				map.getCellAtPoint(forward_point, cell);
				...
				/**TEST*/
				lslgeneric::NDTCell* cellt;
				map.getCellAtPoint(point_center, cellt);
				assert(cellt != NULL);
				lslgeneric::NDTCell* cellt2;
				...
				lslgeneric::NDTCell* cell_collision;
...
// // 			}
		...
		*/
		void getClosestCells(const lslgeneric::NDTMap& map, const lslgeneric::NDTCell& cell, int neig_size, std::vector< boost::shared_ptr< lslgeneric::NDTCell > >& cells_gaussian, std::vector< boost::shared_ptr< lslgeneric::NDTCell > >& cells_initialized){
