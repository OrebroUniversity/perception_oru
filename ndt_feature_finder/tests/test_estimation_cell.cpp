...
int main(){
	...
	lslgeneric::NDTCell* p_cell = new lslgeneric::NDTCell;
	boost::shared_ptr<lslgeneric::NDTCell> cell(p_cell);
	...
	lslgeneric::NDTCell* p_cell2 = new lslgeneric::NDTCell;
	boost::shared_ptr<lslgeneric::NDTCell> cell2(p_cell2);
